...
Finally, note that because this is a living, cutting edge project, you will probably need the most up-to-date version of the `userfriendlyscience` package (*if* that has been submitted to CRAN yet). See https://userfriendlyscience.com for instructions as to how to install it.
...
arrangeGrob(grobs=CIBERlitePlots, ncol=4) %>%
  knitFig(figWidth=21/2.54,
          figHeight=14/2.54,
          figCaption="Figure 1: a CIBER plot.");
